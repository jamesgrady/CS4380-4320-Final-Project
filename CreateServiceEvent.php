...
//            $year = date_format($year, 'Y');
             ...
             if($resultcount == 0){
                 ...
                 $result = pg_prepare($db, "createService", "INSERT INTO events (position_id, point_type, num_of_points, title, event_date, semester)
         VALUES (14, 3, $1, $2, $3, $4)");
                 if($result){
                     $result = pg_execute($db, "createService", array($point, $nameCheck, $date, $semester));
                 }
                 else{
