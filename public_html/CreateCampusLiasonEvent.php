...
<html lang="en">
  <head>
    <title>Add Campus Liason Event</title>
  </head>
    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4>Create Campus Liason Event</h4>
        </div>
...
//            $year = date_format($year, 'Y');
             ...
             if($resultcount == 0){
                 ...
                 $result = pg_prepare($db, "createCL", "INSERT INTO events (position_id, point_type, num_of_points, title, event_date, semester)
         VALUES (22, 5, $1, $2, $3, $4)");
                 if($result){
                     $result = pg_execute($db, "createCL", array($point, $nameCheck, $date, $semester));
                 }
                 else{
