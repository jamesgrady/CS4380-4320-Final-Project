...
<html lang="en">
  <head>
    <title>Add Fundraising Event</title>
  </head>
    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4>Create Fundraising Event</h4>
        </div>
...
//            $year = date_format($year, 'Y');
             ...
             if($resultcount == 0){
                 ...
                 $result = pg_prepare($db, "createFundraising", "INSERT INTO events (position_id, point_type, num_of_points, title, event_date, semester)
         VALUES (11, 4, $1, $2, $3, $4)");
                 if($result){
                     $result = pg_execute($db, "createFundraising", array($point, $nameCheck, $date, $semester));
                 }
                 else{
